...
//
//     final pdpAttendance = pdpAttendanceFromJson(jsonString);

import 'dart:convert';

List<PdpAttendance> pdpAttendanceFromJson(List<dynamic> str) =>
    List<PdpAttendance>.from(str.map((x) => PdpAttendance.fromJson(x)));

String pdpAttendanceToJson(List<PdpAttendance> data) =>
...
class PdpAttendance {
  ...
  factory PdpAttendance.fromJson(Map<String, dynamic> json) => PdpAttendance(
